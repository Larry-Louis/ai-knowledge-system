...
def main() -> None:
    parser = argparse.ArgumentParser(description="GLiNER information richness smoke test")
    parser.add_argument("--model", default="urchade/gliner_base", help="GLiNER model name")
    parser.add_argument("--threshold", type=float, default=0.45, help="Entity threshold")
    parser.add_argument("--text", default="", help="Analyze one custom sentence")
    args = parser.parse_args()

    analyzer = GLiNERInformationRichnessAnalyzer(
